...
mock_product_info = {"title": "Test Product", "price": "$80", "url": "https://example.com/product"}
...
def test_check_price_success(
    mock_get_db_session, mock_apply_async, mock_send_signal, mock_scrape, valid_url, target_price
):
