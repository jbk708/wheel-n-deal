...
def test_check_price_task_no_price_drop(mock_scraper, mock_db_session, mock_signal, mock_apply_async):
...
def test_check_price_task_product_not_found(mock_scraper, mock_db_session, mock_signal, mock_apply_async):
...
def test_check_price_task_database_error(mock_scraper, mock_db_session, mock_signal, mock_apply_async):
...
def test_check_price_task_scraper_error(mock_scraper, mock_db_session, mock_signal, mock_apply_async):
